...
const HOME_FILE = path.join(process.cwd(), 'ColorFiind_V14_SEO_Backend_Home.html');
...
function loadPalettes(){
  ...
  vm.runInContext(engine,sandbox,{timeout:5000});
...
module.exports = async function handler(req,res){
  ...
  if(req.method === 'POST' && route.startsWith('api/likes/')){
